...
class Player(pygame.sprite.Sprite):
    ...
    # Draw player health bar above player
        ...
        outline_rect = pygame.Rect(self.rect.x - camera_x, self.rect.y - 10, bar_width, bar_height)
        fill_rect = pygame.Rect(self.rect.x - camera_x, self.rect.y - 10, fill, bar_height)
        pygame.draw.rect(surface, (255, 0, 0), outline_rect)  # red background
        pygame.draw.rect(surface, (0, 255, 0), fill_rect)      # green fill
        pygame.draw.rect(surface, (0, 0, 0), outline_rect, 1)  # border
...
class BossEnemy(pygame.sprite.Sprite):
    ...
    def draw(self, surface, camera_x):
        ...
        bar_width = 80
        bar_height = 8
        fill = (self.health / 300) * bar_width
        outline_rect = pygame.Rect(self.rect.x - camera_x, self.rect.y - 15, bar_width, bar_height)
        fill_rect = pygame.Rect(self.rect.x - camera_x, self.rect.y - 15, fill, bar_height)
        pygame.draw.rect(surface, (255, 0, 0), outline_rect)
        pygame.draw.rect(surface, (0, 255, 0), fill_rect)
        pygame.draw.rect(surface, (0, 0, 0), outline_rect, 1)
